...
SmallObstacleXS = function()
{
    this.remove = false;

    this.texture = Files.PIC_GAME_OBJECT_OBSTACLESMALLXS;
...
SmallObstacleXS.prototype.onPlayerCollision = function(player)
{
    this.collisionContainer.isColliding = true;
    player.onCollision();
};

SmallObstacleXS.prototype.tick = function()
{
...
SmallObstacleXS.prototype.draw = function(gfx)
{
